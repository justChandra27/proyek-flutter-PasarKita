...
class DetailProdukCustomerMobile extends StatefulWidget {
  final String productId;

  const DetailProdukCustomerMobile({super.key, required this.productId});

  @override
  State<DetailProdukCustomerMobile> createState() =>
      _DetailProdukCustomerMobileState();
}

class _DetailProdukCustomerMobileState
    extends State<DetailProdukCustomerMobile> {
  ...
  Widget _buildBottomBar() {
    final outOfStock = _product!.stock <= 0;
    return Container(
