...
class DetailProdukSellerWeb extends StatefulWidget {
  final String productId;

  const DetailProdukSellerWeb({super.key, required this.productId});

  @override
  State<DetailProdukSellerWeb> createState() => _DetailProdukSellerWebState();
}

class _DetailProdukSellerWebState extends State<DetailProdukSellerWeb> {
                            ...
                            child: SizedBox(
                              ...
                              child: OutlinedButton.icon(
                                ...
                                style: OutlinedButton.styleFrom(
                                  foregroundColor: product.active
                                      ? Colors.red
                                      : Colors.green,
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(12),
